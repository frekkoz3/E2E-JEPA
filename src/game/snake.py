...
class SnakeEnv(gym.Env):
    ...
    def __init__(self, render_mode=None, max_step=100, observation_type="grid", difficulty=0, rescale_frames : bool = False, **kwargs):
        ...
        if kwargs == {}:
            ...
            self.reward_illegal_action = kwargs["reward_illegal_action"]
    ...
    def death_state(self):
        if self.observation_type == "image":
            ...
            all_black_t = np.transpose(all_black, (2, 1, 0)) # format for the ViT
            return all_black_t
        else:
    ...
    def step(self, action):
        ...
        if (new_dir[0] * -1, new_dir[1] * -1) != self.direction:
            ...
            reward = self.reward_illegal_action
    ...
    def _render_frame(self):
        ...
        return np.transpose(img_array.copy(), (2, 1, 0)) # some format
